...
import './css/MapViewMobile.scss';
import Map from './components/Map';
import $ from 'jquery';
import PropTypes from 'prop-types';
import { _, interpolate } from './classes/gettext';

class MapView_mobile extends React.Component {
  static defaultProps = {
    mapItems: [],
...
$(function(){
    $("[data-mapview]").each(function(){
        ...
        window.ReactDOM.render(<MapView_mobile {...props}/>, $(this).get(0));
    });
});

export default MapView_mobile;
